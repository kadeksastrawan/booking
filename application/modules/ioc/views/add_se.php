          ...
          <div class="block">
            ...
            <div class="data-fluid">
					...
					<?php echo form_hidden('docs_from',$nama)?>
					  ...
					  <div class="row-form">
                        ...
                        <div class="span4 col-sm-4">
                          <input type="text" class="mask_date" id="datepicker" placeholder="Tanggal Terima" name="docs_date_in" value="<?php echo mdate("%d-%m-%Y",time());?>">
                        </div>
                      </div>  
					...
					<div class="row-form">
                        ...
                        <div class="span4 col-sm-4">
                          <input type="text" class="mask_date" id="datepicker2" placeholder="Tanggal Dokumen" name="docs_date" value="<?php echo mdate("%d-%m-%Y",time());?>">
                        </div>
                      </div>          
					...
					<div class="data">
						<div id="editable" class="typography" contenteditable="true">
					      	<table>
							<tr><td colspan="2"><b>DIREKSI PT. GAPURA ANGKASA</b></td></tr></div>
							<tr><td><br/></td><td></td></tr>
							<tr><td><br/></td><td><i>uraian Surat Edaran</i></td></tr>
							<tr><td><br/></td><td></td></tr>
							<tr><td><br/></td><td></td></tr>
