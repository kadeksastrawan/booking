<?php include($this->config->item('header')); ?>
	<div class="content">
        <div class="page-header">
            ...
            <h1>Closed Correspondence</h1>
        </div>

      <!-- row title -->
      <div class="row">
        <div class="col-lg-12">
          <h4 class="page-title"><?php echo anchor('ioc/dashboard', 'IOC', 'title="Inter Office Correspondence"');?> <i class="fa fa-angle-double-right"></i> COMPLETED </h4>
        </div>
      </div>
      <!-- row -->
        ...
        <div class="span10 col-lg-10">
          ...
          <div class="block">
            ...
            <div class="data-fluid">
                ...
                <hr />
                <?php echo $link_completed; ?>
                <p class="text-warning"><small><i class="fa fa-info-circle"></i> list of completed inter office correspondence.</small></p>
