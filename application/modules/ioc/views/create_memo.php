<?php include($this->config->item('header')); ?>
	<div class="content">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h4 class="page-title"><?php echo anchor('ioc/dashboard', 'IOC', 'title="Inter Office Correspondence"');?> <i class="fa fa-angle-double-right"></i> Create Memo </h4>
        </div>
      </div>
      <!-- row -->
          ...
          <div class="block">
            ...
            <div class="data-fluid">
            		...
            		<?php if(validation_errors()){echo '<div class="badge-warning">'.validation_errors().'</div>';} ?>
                  	...
                  	<?php echo form_open_multipart('ioc/create/save_memo', 'class="form-horizontal"'); ?>
                   ...
                   <div class="row-form">
					...
					<div class="form-group">
                        ...
                        <div class="span4 col-sm-4">
                          <input type="text" class="form-control" id="inputDari" name="docs_type" value="Memo">
                        </div>
                    </div>
					...
					<div class="row-form">
                      ...
                      <div class="row-form">
                        ...
                        <div class="span4 col-sm-4">
                          <input type="text" class="form-control" id="inputDari" name="docs_from" placeholder="Dari">
                        </div>
                      </div>       
                      ...
                      <div class="row-form">
                        ...
                        <div class="span4 col-sm-4">
                          	<input type="text" class="form-control" id="inputKepada" name = "docs_to" placeholder="Kepada">
                        </div>
                      </div>      
