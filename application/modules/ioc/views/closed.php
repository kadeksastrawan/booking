<?php include($this->config->item('header')); ?>
	<div class="content">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h4 class="page-title"><?php echo anchor('ioc/dashboard', 'IOC', 'title="Inter Office Correspondence"');?> <i class="fa fa-angle-double-right"></i> CLOSED </h4>
        </div>
      </div>
      <!-- row -->
        ...
        <div class="span10 col-lg-10">
          ...
          <div class="block">
            ...
            <div class="data-fluid">
                ...
                <?php echo $link_closed; ?>
                
				<p class="text-warning"><small><i class="fa fa-info-circle"></i> list of ignored inter office correspondence.</small></p>
