...
class Open extends CI_Controller {
	 ...
	 * PT Gapura Angkasa
	 * Module : Nota Dinas 
	 * Sub Module : Open Nota Dinas
	 *
	 * open controller
	 *
	 * url : http://localhost/github/office/modules/ioc/controller/open.php
	...
	function index()
	{
		redirect('ioc/open/corresspondence');
	}
	...
	function corresspondence()
	{
		...
		$config = array();
		$config['base_url'] = site_url() . '/ioc/open/corresspondence/';
		$config['per_page'] = 2; 
		...
		$data['total_open'] = $this->docs_model->stat_my_open($ui_nipp);
		...
		# call model
		$data['list_open'] = $this->docs_model->docs_open($ui_nipp, $offset, $limit);
...
/* Location: ./application/modules/ioc/controllers/open.php */