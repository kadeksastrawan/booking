      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <div class="widget">
          	...
          	<div class="widget-header">    <h3><i class="fa fa-check-square"></i> edit pangkat</h3> </div>
            ...
            <div class="widget-content">
            		...
            		<?php echo form_open('admin/fungsi/update'); ?>
                ...
                <div class="row">
    				...
    				<div class="col-sm-4">
					<?php echo form_input('vf_code', $items->vf_code, 'class="form-control" placeholder="Function Code" '); ?>
                	</div>
              	</div>
                </div>
                ...
                <div class="row">
    				...
    				<div class="col-sm-4">
                	<?php echo form_input('vf_name', $items->vf_name, 'class="form-control" placeholder="Function Name" '); ?>
                	</div>
              	</div>
                </div>
                ...
                <div class="form-group">
    				...
    				<div class="col-sm-4">
                	<?php echo form_submit('submit', 'update', 'class="form-control btn btn-primary pull-right"'); ?>
                	</div>
              	</div>
                </div>
