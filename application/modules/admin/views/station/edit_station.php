      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div class="widget">
			...
			<?php echo form_open('admin/station/update'); ?>
            ...
            <?php 
				foreach($query as $items) : 
					$stn_code = $items->vs_code;
					$stn_name = $items->vs_name;
					$parent_id = $items->vs_vd_id;
					$id = $items->vs_id;
				endforeach; 
			?>
			...
			<tr>
				<td>Code</td>
				<td><?php echo form_input('code', strtoupper($stn_code),'class="form-group" readonly="readonly"'); ?></td>
			</tr>
			
			<tr>
				<td>Name</td>
				<td><?php echo form_input('name', strtoupper($stn_name),'class="form-group"'); ?></td>
			</tr> 
