...
class Login extends CI_Controller {
	...
	/**
		 ...
		 *
		 * url : http://localhost/github/office/application/modules/admin/controllers/login.php
...
# constuction ------------------------------	
	 function __construct()
	{
		...
		# check module active
		if($this->user_access->module_active('module_active') == FALSE){redirect('user/password_login');}
	...
	public function pin_do_login()
	{
		...
		else
		{
			...
			if($result)
			{
					...
					$email_db = @file_get_contents(FCPATH . 'wp-uploads/data/tmp/' . $ui_d . '.tmp');
